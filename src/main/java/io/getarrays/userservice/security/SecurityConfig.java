...
import io.getarrays.userservice.filter.CustomAuthencationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().mvcMatchers(GET,"/api/user/**").hasAnyAuthority("ROLE_USER");
        http.authorizeRequests().mvcMatchers(POST,"/api/user/save/**").hasAnyAuthority("ROLE_ADMIN");
